...
#define ft_open_params    FT_OPEN_PARAMS
  ...
  /*    @FT_Reference_Face.                                                */
  /*                                                                       */
  /*    To tick over all faces, use code similar to the following snippet  */
  ...
  /*    }                                                                  */
  /*                                                                       */
  /*    To tick over all valid values for `face_index', use something      */
  /*    similar to the following snippet, again without error handling.    */
  /*    The code accesses all faces immediately (thus only a single call   */
  /*    of `FT_Open_Face' within the do-tick), with and without named      */
  /*    instances.                                                         */
  /*                                                                       */
  /*    {                                                                  */
  /*      ...                                                              */
